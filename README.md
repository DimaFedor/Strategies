...
- ![equity_curve](https://live.staticflickr.com/65535/54418218860_7dc0f16518_b.jpg)
  - Це крива капіталу (Equity Curve), яка показує зміну вартості портфеля з часом при застосуванні стратегії ATR Breakout. Ця динаміка означає, що стратегія приносила `стабільні збитки` протягом усього періоду, без видимого відновлення.
- ![HEAT](https://live.staticflickr.com/65535/54418218855_3da0e45988_b.jpg)
- Це теплокарта (heatmap), яка відображає загальний прибуток або збиток для різних торгових пар (символів). Більшість активів знаходяться у відʼємній зоні, що свідчить про втрати капіталу.
  -Є й винятки: WIFBTC (85.0%) показує значний прибуток, що означає, що стратегія працювала добре лише для окремих активів.
...
- ![equity_curve](https://live.staticflickr.com/65535/54417836851_31a67530cc_b.jpg)<br>
  - Цей графік відображає зміну вартості портфеля в часі під час бектесту стратегії `SMA Crossover`.
  - Спостерігається стійкий спад, що свідчить про неефективність стратегії в даних ринкових умовах.
- ![HEAT](https://live.staticflickr.com/65535/54418224960_63161c761a_b.jpg)
  - Це теплокарта (heatmap), яка відображає загальний прибуток або збиток для різних торгових пар (символів). Більшість активів знаходяться у відʼємній зоні, що свідчить про втрати капіталу
  - Деякі активи (наприклад, PNUTBTC із прибутком 81.1%) показали позитивний результат, але загальна картина свідчить про великі втрати.
  - Значення від -99.3% до +81.1% свідчать про високу волатильність активів у вибірці.
...
- Якщо прибрати аномальні позиції виходить ось так
  ...
  - <b>Загальні висновки</b> по стратегії дуже приємні і є дуже ефективною в рамках реального ринку `(2025-02-01/2025-02-28)`.
  - ![equity_curve](https://live.staticflickr.com/65535/54416976602_e72c32a747_b.jpg)<br>
  - На цьому графіку я бачу зміну вартості портфеля в часі під час бектесту стратегії `VWAP Reversion Intraday`.
  - Спостерігається стійкий ріст, що свідчить про ефективність стратегії в даних ринкових умовах.
  - ![HEAT](https://live.staticflickr.com/65535/54418090813_2b93a2a080_b.jpg)
  - Ця теплокарта показує загальну дохідність кожного активу у стратегії `VWAP Reversion`.
  - Більшість активів мають від’ємну або незначну позитивну дохідність
  - Декілька активів показали надзвичайно високий прибуток, зокрема:
    - JSTBTC → +94 643.7%
    - IOTXBTC → +5 049.0%
    - PEOPLEBTC → +2 412.7%
    - VETBTC → +1 219.3%
  - Високий прибуток на окремих активах свідчить про те, що стратегія могла працювати лише для кількох активів прибутково, але в загальному стратегія була нерівномірною та нестабільною, бо більшість активів показали збитки
